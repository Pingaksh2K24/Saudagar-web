...
export const setAuthProps = (data) => {
  console.log('Setting auth props:', data);
  const authProps = {
    cookieName: authCookieName,
    cookieValue: data,
    createdAt: Date.now(),
    expirationTime: data.token.expiresIn,
  };
...
export const setTokenProps = (data) => {
  console.log('Setting token props:', data);
  const tokenProps = {
    cookieName: tokenCookieName,
    cookieValue: data?.accessToken,
  };
